...
public class InvalidEndpointTest {
    ...
    public void attemptHttpOnMemcacheEndpoint()
            throws IOException {
        ServerSocketEndpointConfig restEndpoint = new ServerSocketEndpointConfig();
        ...
        config.getAdvancedNetworkConfig()
              .setEnabled(true)
              .setMemcacheEndpointConfig(restEndpoint);
    ...
    private HTTPCommunicator.ConnectionResponse doHttpGet(String url) throws IOException {
